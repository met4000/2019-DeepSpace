...
const tAxis ControlMap::forwardAxis{ 1, AxisMap::kYAxis };
const tAxis ControlMap::turnAxis{ 1, AxisMap::kZAxis };
const tAxis ControlMap::forwardAxisFOC{ 1, AxisMap::kYAxis };
const tAxis ControlMap::turnAxisFOC{ 1, AxisMap::kXAxis };
...
// BEELEVATOR JOYMAP
const std::vector<tButton> ControlMap::raiseLift{};
const std::vector<tButton> ControlMap::lowerLift{};
...
// HATCH JOYMAP
const std::vector<tButton> ControlMap::hatchGrab{ { 1, 3 }, { 2, 6 }, { 3, XboxController::kA } };
const std::vector<tButton> ControlMap::hatchRelease{ { 1, 5 }, { 2, 4 }, { 3, XboxController::kY } };
const std::vector<tButton> ControlMap::hatchStow{}; //{ { 3, 6 } };
const std::vector<tButton> ControlMap::hatchToggleEnabled{ { 3, XboxController::kStickRight } }; // Changes the currently enabled hatch intake



// BOX INTAKE JOYMAP
const std::vector<tButton> ControlMap::boxIn{ { 1, 4 }, { 2, 5 }, { 3, 2 } };   // reversed
const std::vector<tButton> ControlMap::boxOut{ { 1, 6 }, { 2, 3 }, { 3, 3 } };  // reversed
const std::vector<tButton> ControlMap::boxStow{ { 3, 5 } };
...
// CONTROLSYSTEM JOYMAP
const std::vector<tButton> ControlMap::compressorOn{ { 2, 2 }, { 3, 7 } };
